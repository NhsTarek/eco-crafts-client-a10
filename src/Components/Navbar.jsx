...
const Navbar = () => {
    ...
    const navLinks = <>
        ...
        <li className="font-poppins font-bold"><NavLink to="/allArts&Crafts"> All Art & craft Items</NavLink></li>
        <li className="font-poppins font-bold"><NavLink to="/addCraftItem">Add Craft Item</NavLink></li>
        <li className="font-poppins font-bold"><NavLink to="/myCraftList"> My Art&Craft List</NavLink></li>
    ...
    return (
        <div className="navbar bg-base-100 my-5">
            <div className="navbar-start">
                ...
                <Link to="/" className="btn btn-ghost md:text-xl lg:text-xl font-poppins">EcoCrafts Hub</Link>
            </div>
